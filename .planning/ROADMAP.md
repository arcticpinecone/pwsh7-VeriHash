...
### Phase 6: Sidecar auto-detect — right-click .sha256 verifies companion
...
### Phase 7: Output formatting — rich single-file report + batch table
...
### Phase 8: Manifest spot-check — single-file verify against existing manifest
